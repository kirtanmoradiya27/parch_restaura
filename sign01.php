...
<body class="index-page" style="height: 100%;">
  <header id="header" class="header d-flex align-items-center sticky-top">
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <div class="">
        <!-- <a class="btn-getstarted" href="sign01.html">Sign Up</a> -->
        <!-- <a class="btn-getstarted" href="Login01.html">Login</a> -->
        ...
        <div class="col-12 col-md-6 col-xl-7">
          <div class="d-flex justify-content-start ">
            <div class="col-12 col-xl-9">
              <h1 id="logo" class="d-inline">Ph</h1><span
              ...
              <h2 class="h1 mb-4 ">Perch: Where Every Meal Sits Just Right</h2>
              <p class="lead mb-5 ">
            ...
            <div class="card-body opacity-100 p-3 p-md-4 p-xl-5">
              <div class="row">
                <div class="col-12">
                  ...
                  <div>
                    <p>Already Have Account? <a class="link-a" href="Login01.php">Login</a></p>
                  </div>
                </div>
              </div>
              <form action="#!">
                <div class="row gy-3 overflow-hidden">
                  ...
                  <div class="col-12">
                    <div class="d-grid">
                      <button class="btn btn-primary btn-lg" type="submit" href="index.php">Sign Up</button>
                    </div>
                  </div>
                </div>
              </form>
